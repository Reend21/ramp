				...
				options = {
					...
					{ -- Suspicion
						...
						options = {
							{
								type = "toggle",
								name_id = "wolfhud_susp_custom_huds_support_title",
								desc_id = "wolfhud_susp_custom_huds_support_desc",
								value = {"HUDSuspicion", "CUSTOM_HUDS_SUPPORT"},
								visible_reqs = {}, enabled_reqs = {},
							},
							{
								type = "divider",
			...
			-- Menu Tweaks
			{
				...
				options = {
					...
					},
					{
						...
						value = {"INVENTORY", "SHOW_EMPTY_LOBBY2"},
						visible_reqs = {}, enabled_reqs = {},
					},
					{
						type = "toggle",
